	...
	<div class="container page">
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="POST" action="<?php echo e(url('siswa/update_siswa/'.$siswa->id)); ?>" class="form">
					<?php echo csrf_field(); ?>
					<div class="form-group row">
					    <label for="nama" class="col-sm-2 col-form-label">Nama Siswa</label>
						<div class="col-sm-10">
						     <input type="text" class="form-control" id="nama" placeholder="Nama Siswa" name="nama" value="<?php echo e($siswa->nama); ?>">
						</div>
					</div>
					<div class="form-group row">
